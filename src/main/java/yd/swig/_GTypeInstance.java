...
public class _GTypeInstance {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        fridacoreJNI.delete__GTypeInstance(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setG_class(_GTypeClass value) {
    fridacoreJNI._GTypeInstance_g_class_set(swigCPtr, this, _GTypeClass.getCPtr(value), value);
  }

  public _GTypeClass getG_class() {
    long cPtr = fridacoreJNI._GTypeInstance_g_class_get(swigCPtr, this);
    return (cPtr == 0) ? null : new _GTypeClass(cPtr, false);
  }

  public _GTypeInstance() {
    this(fridacoreJNI.new__GTypeInstance(), true);
  }
