...
public final class GHookFlagMask {
  public final static GHookFlagMask G_HOOK_FLAG_ACTIVE = new GHookFlagMask("G_HOOK_FLAG_ACTIVE", fridacoreJNI.G_HOOK_FLAG_ACTIVE_get());
  public final static GHookFlagMask G_HOOK_FLAG_IN_CALL = new GHookFlagMask("G_HOOK_FLAG_IN_CALL", fridacoreJNI.G_HOOK_FLAG_IN_CALL_get());
  public final static GHookFlagMask G_HOOK_FLAG_MASK = new GHookFlagMask("G_HOOK_FLAG_MASK", fridacoreJNI.G_HOOK_FLAG_MASK_get());
